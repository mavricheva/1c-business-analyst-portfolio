...
|---|---|---|
| BR-001 | В форме не отображается поле «Сумма документа» | Средний |
| BR-002 | В ТЧ «Товары» доступна вся номенклатура, включая услуги | Средний |
| BR-003 | В ТЧ «Услуги» отсутствует отбор по типу «Услуга» | Средний |
| BR-004 | Невозможно проверить запрет редактирования суммы (поле отсутствует) | Средний |
| BR-005 | Цена из регистра доступна для ручного изменения без контроля | Низкий |
| BR-006 | В печатной форме не выводится поле «Склад» | Низкий |
| BR-007 | При создании на основании не переносится комментарий | Средний |
